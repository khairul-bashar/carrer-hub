...
const FeatureJob = ({ job }) => {
  const { id, jobName, companyName, location, salary, jobType, logoLink } = job
  return (
    <div className="border rounded-md border-slate-200 px-6 py-4">
      <div>
        <img className="w-32 h-20" src={logoLink} alt="" />
      </div>
      <h2 className="text-2xl font-extrabold text-secondary my-2">{jobName}</h2>
